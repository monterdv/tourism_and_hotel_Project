<template>
  <form @submit.prevent="createpost" enctype="multipart/form-data">
    <a-card title="Create new post" style="width: 100%" class="shadow">
      <div class="row">
...
export default defineComponent({
  setup() {
    ...
    const getCreatePost = () => {
      ...
      axios
        .get("http://127.0.0.1:8000/api/dashboard/post/create")
    ...
    const createpost = () => {
      ...
      axios
        .post("http://127.0.0.1:8000/api/dashboard/post/create", formData)
        .then(function (response) {
          // console.log(response);
          loader.hide();
          if (response) {
